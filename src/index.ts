...
import { treatSchema } from "./generator/treat"
import { OpenAPIManifold } from "./generator/types"
import { generateApisFiles } from "./generator/generate"
...
async function generateApiLibrary(
  ...
  output.splice(
    1,
    0,
    "import { Without, XOR, OneOf, WithRequired } from \"@ewam/openapi-typescript\"",
    ""
  )
